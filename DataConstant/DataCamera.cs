...
public class DataCamera
{
    ...
    public static PoseCamera[] poseRangeFromCUDAE = new PoseCamera[3]{
                    new PoseCamera("MS-D-HA", new Vector3(0f, 1.71f, 0f), new Vector3(0f, 1.9f, 1f), new Vector3(20f, 180f, 0f), new Vector3(27f, 180f, 0f),5f),
                    new PoseCamera("LS-D-HA", new Vector3(0f, 1.71f, 1f), new Vector3(0f, 1.9f, 2f), new Vector3(27f, 180f, 0f), new Vector3(32f, 180f, 0f),4f),
                    new PoseCamera("MS-D", new Vector3(0f, 0.8f, 1f), new Vector3(0f, 1.5f, 1f), new Vector3(01f, 180f, 0f), new Vector3(0f, 180f, 0f),2f)
                };

    public static PoseCamera[] poseRangeFromMSDHA = new PoseCamera[2] {
                   new PoseCamera("MS-D", new Vector3(0f, 0.8f, 1f), new Vector3(0f, 1.5f, 1f), new Vector3(01f, 180f, 0f), new Vector3(0f, 180f, 0f),2f),
                    new PoseCamera("CU-D-AE", new Vector3(0f, 1.2f, 0.2f), new Vector3(0f, 1.3f, 1f), new Vector3(0f, 180f, 0f), new Vector3(0f, 180f, 0f),3f),
                };
    ...
    public static PoseCamera[] poseRangeFromLSDHA = new PoseCamera[2] {
                    new PoseCamera("MS-D", new Vector3(0f, 0.8f, 0f), new Vector3(0f, 1.5f, 1f), new Vector3(01f, 180f, 0f), new Vector3(0f, 180f, 0f),2f),
                    new PoseCamera("MS-D-HA", new Vector3(0f, 1.71f, 0f), new Vector3(0f, 1.9f, 1f), new Vector3(20f, 180f, 0f), new Vector3(27f, 180f, 0f),4f),
                    };
